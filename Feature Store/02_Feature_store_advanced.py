...
# MAGIC To run this demo, just select the cluster `dbdemos-feature-store-victor_rodrigues` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/0531-122921-m4fwbjmv/configuration)). <br />
