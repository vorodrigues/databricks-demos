...
EEO_schema = StructType([
  StructField('applicationId', StringType(), True), 
  StructField('deviceId', StringType(), True), 
  StructField('messageProperties', StructType([
    StructField('iothub-connection-device-id', StringType(), True), StructField('iothub-creation-time-utc', StringType(), True), 
    StructField('iothub-interface-id', StringType(), True)]), True), 
  StructField('telemetry', StructType([
    StructField('batchNumber', LongType(), True), StructField('cpuLoad', DoubleType(), True), StructField('defectivePartsMade', LongType(), True), 
    StructField('machineHealth', StringType(), True), StructField('memoryFree', LongType(), True), StructField('memoryUsed', LongType(), True), 
    StructField('messageTimestamp', StringType(), True), StructField('oilLevel', DoubleType(), True), StructField('plantName', StringType(), True), 
    StructField('productionLine', StringType(), True), StructField('shiftNumber', LongType(), True), StructField('systemDiskFreePercent', LongType(), True), 
    StructField('systemDiskUsedPercent', LongType(), True), StructField('temperature', DoubleType(), True), StructField('totalPartsMade', LongType(), True)]), True)
])
...
def create_agg_kpi_metrics():
  bus_agg = (dlt.read_stream("OEE_silver")
          ...
          .withColumn("time", F.col("window.end")))
