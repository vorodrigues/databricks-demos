...
# MAGIC %md ## 3/ Gold layer: join information on Turbine status to add a label to our dataset
...
# MAGIC %md Now, let's try to insert data with an invalid status.
...
# MAGIC %sql
# MAGIC DELETE FROM turbine_gold where timestamp < '2020-01-01';
...
# MAGIC %sql RESTORE turbine_gold VERSION AS OF 11
...
# MAGIC %md
# MAGIC ## Don't forget to stop all the streams once your demo is over
