...
share_profile = '/dbfs/FileStore/shares/vr_fraud.share'
...
df = delta_sharing.load_as_spark(f"/FileStore/shares/vr_fraud.share#vr_fraud_share.vr_fraud_share.visits_wells")
display(df.head(10))
