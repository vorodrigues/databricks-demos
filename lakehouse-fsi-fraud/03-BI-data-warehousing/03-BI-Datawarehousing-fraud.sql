...
-- MAGIC
-- MAGIC The Dashboard has been loaded for you. Open the <a dbdemos-dashboard-id="fraud-detection" href='/sql/dashboardsv3/01ef6eb14cf4102580326c8cd4bc9ccb' target="_blank">DBSQL FSI Fraud Dashboard</a> to start reviewing our existing Fraud pattern.
