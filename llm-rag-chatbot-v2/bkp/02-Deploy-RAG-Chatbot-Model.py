...
question = {"prompt": "How can I track billing usage on my workspaces?"}
...
with mlflow.start_run(run_name='dbdemos_chatbot_rag2') as run:
  ...
  mlflow.pyfunc.log_model(
    ...
    artifact_path='model',
    registered_model_name=model_name+'2', 
    signature=signature, 
    pip_requirements=[
            "git+https://github.com/mlflow/mlflow.git@gateway-migration",
            "git+https://github.com/langchain-ai/langchain.git@master#subdirectory=libs/langchain",
  ...
  import mlflow.models.utils
  v = get_latest_model_version(model_name+'2')
  mlflow.models.utils.add_libraries_to_model(f"models:/{model_name}2/{v}")
...
serving_endpoint_name = f"dbdemos_endpoint_{catalog}_{db}_mod"[:63]
latest_model_version = get_latest_model_version(model_name+'2')
...
ai_gateway_route_name = "vr_dbdocs_chatbot"
